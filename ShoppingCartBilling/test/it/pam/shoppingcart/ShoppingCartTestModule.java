...
import it.pam.shoppingcart.visualizer.SysoutVisualizer;
import it.pam.shoppingcart.visualizer.Visualizer;
...
public class ShoppingCartTestModule extends AbstractModule {

	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ShoppingCartTestModule.class);
	...
	protected void configure() {
		...
		bind(Visualizer.class).to(SysoutVisualizer.class);
